...
import LeftToRight from "../../Shared/motion/LeftToRight";
import BtmToTop from "../../Shared/motion/BtmToTop";
            ...
            <article className="flex flex-col  gap-5">
                ...
                <div className="location card bg-base-100 w-60 md:w-96  shadow-sm border-b-2">
                    ...
                    <div className="w-full h-40 overflow-hidden  ">
                        <Location
                            coordinatesData={
                                data?.[userIndex]?.location?.coordinates
                            }
                        />
                    </div>
